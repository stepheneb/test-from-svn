...
<head>
	...
	<title>Evolution Readiness <?php echo $sassy_config['site_title']; ?> - <?php echo $page_title; ?></title>
	...
	<!--[if lt IE 7]>
	<link rel="stylesheet" href="/css/er-ie.css" type="text/css">
	<![endif]-->
...
<div id="main-content">
	...
	<h1>Evolution Readiness Portal — <?php echo $page_title; ?></h1>
	...
	<div id="sidebar-content">
		...
		<div><a href="http://er.concord.org/"><img src="/images/er-logo.png" alt="Evolution Readiness"></a></div>

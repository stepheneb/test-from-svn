...
$portal_config['mystery_database_connection'] = 'mysql://portal_admin:W?rm%*(3@database.concord.org/mystery4';
$portal_config['portal_database_connection'] = 'mysql://portal_admin:W?rm%*(3@database.concord.org/ccportal';
$portal_config['sunflower_database_connection'] = 'mysql://portal_admin:W?rm%*(3@database.concord.org/sunflower';

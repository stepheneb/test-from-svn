...
$portal_config['project_settings']['itsi']['teacher_available_actions'] = array('create', 'copy', 'edit', 'info', 'preview', 'report', 'run', 'try');
...
$portal_config['project_settings']['udl']['teacher_available_actions'] = array('info', 'report', 'try');
...
$portal_config['project_settings']['capa']['teacher_available_actions'] = array('info', 'report', 'run', 'try');
...
$portal_config['project_settings']['loops']['teacher_available_actions'] = array('create', 'copy', 'edit', 'info', 'preview', 'report', 'run', 'try');
...
$portal_config['project_settings']['ri-itest']['teacher_available_actions'] = array('info', 'report', 'try');
...
$portal_config['project_settings']['paemst']['teacher_available_actions'] = array('create', 'copy', 'edit', 'info', 'preview', 'report', 'run', 'try');

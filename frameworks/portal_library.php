...
function portal_get_class_info_by_student($student_id) {
  // this function returns the class info associated with a student
  $query = 'SELECT * FROM portal_classes WHERE class_id = (SELECT class_id FROM portal_class_students WHERE member_id = ?)';
